...
window.WeStickyIcky = require('./components/we_sticky_icky');
window.PricingTabs = require('./components/pricing/pricing_tabs');
window.PricingTable = require('./components/pricing/pricing_table');
window.PricingCommonsStarter = require('./components/pricing/pricing_commons_starter');
